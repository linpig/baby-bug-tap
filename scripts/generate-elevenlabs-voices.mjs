...
const voiceLines = [
  ...
  { id: 'number-0', text: '零', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-1', text: '一', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-2', text: '二', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-3', text: '三', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-4', text: '四', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-5', text: '五', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-6', text: '六', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-7', text: '七', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-8', text: '八', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  { id: 'number-9', text: '九', languageCode: 'zh', voiceSettings: teacherVoiceSettings },
  ...letters.map((letter) => ({
